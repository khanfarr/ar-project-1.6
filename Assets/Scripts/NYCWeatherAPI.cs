...
public class NYCWeatherAPI : MonoBehaviour
{
    ...
    private IEnumerator RefreshOnce()
    {
        ...
        using UnityWebRequest request = UnityWebRequest.Get("https://api.open-meteo.com/v1/forecast?latitude=40.7128&longitude=-74.0060&current_weather=true&temperature_unit=celsius&windspeed_unit=kmh");
        request.timeout = 10;
