...
public class NYCNumFlightsAPI : MonoBehaviour
{
    ...
    private IEnumerator RefreshOnce()
    {
        ...
        using UnityWebRequest request = UnityWebRequest.Get("https://opensky-network.org/api/states/all?lamin=40.30&lomin=-74.40&lamax=41.10&lomax=-73.50");
        request.timeout = 10;
